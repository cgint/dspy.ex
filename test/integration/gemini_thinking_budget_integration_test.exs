# Opt-in integration smoke test for running Gemini through `Dspy.LM.new/2` with thinking_budget.
#
...
#     test/integration/gemini_thinking_budget_integration_test.exs

defmodule Dspy.GeminiThinkingBudgetIntegrationTest do
  ...
  @tag timeout: 120_000
  test "Gemini works with thinking_budget 0 (disabled)" do
  ...
  @tag timeout: 120_000
  test "Gemini works with thinking_budget 512" do
    {:ok, lm} = Dspy.LM.new("gemini/gemini-2.5-flash", thinking_budget: 512)
