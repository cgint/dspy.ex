# signature-adapter-message-pipeline-completion Specification

## Purpose
TBD - created by archiving change adapter-pipeline-parity-completion. Update Purpose after archive.
## Requirements
